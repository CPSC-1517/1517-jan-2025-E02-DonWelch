...
//if you wish a single instance return from the .Where, you could use
//a) .FirstOrDefault() returns is the first instance to meet predicate OR if none meet predicate, a null is returned
//b) .SingleOrSefault() returns the first value to meet predicate OR if none meet predicate, a null/0/false (depending on datatype) is returned
Console.WriteLine("\n\nLinq results\n");

...
namespace WestWindSystem.BLL
{
    public class RegionServices
    {
        ...
        public Region Region_GetByID(int regionid)
        {
            ...
            //the predicate for this method is the condition for match to find the desired record

            //since the query is based on the pkey of the table, only one record, if any,
            //    should be found
